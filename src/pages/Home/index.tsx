...
import { useTranslation, Trans } from "react-i18next"; // from https://react.i18next.com/latest/trans-component
    ...
    <Box p={2} maxHeight="calc(100vh - 64px)" overflow={["auto", "auto"]}>
      <Container>
        ...
        <Typography variant="subtitle1" textAlign="center">
          {/* https://react.i18next.com/latest/trans-component#alternative-usage-which-lists-the-components-v11.6.0 */}
